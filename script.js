...
document.getElementById('device').innerHTML = '電燈已開啟'; 
} 
   function changeLED_OFF() { 
document.getElementById('device').innerHTML = '電燈已關閉'; 
} 
   function changeFAN_ON() { 
document.getElementById('device').innerHTML = '風扇已開啟'; 
} 
   function changeFAN_OFF() { 
document.getElementById('device').innerHTML = '風扇已關閉'; 
} 
   function changeFAN_HIGHT() { 
document.getElementById('device').innerHTML = '提高風速'; 
} 
   function changeFAN_LOW() { 
document.getElementById('device').innerHTML = '降低風速'; 
} 
   function changeDOOR_ON() { 
document.getElementById('device').innerHTML = '大門已開啟'; 
} 
   function changeDOOR_OFF() { 
document.getElementById('device').innerHTML = '大門已關閉'; 
} 
   function changeLIGHT_ON() { 
document.getElementById('device').innerHTML = '現在室內亮度'; 
} 
   function changeLIGHT_OFF() { 
document.getElementById('device').innerHTML = '現在室內亮度'; 
} 
   function changetemperature_ON() { 
document.getElementById('device').innerHTML = '現在室內溫度'; 
} 
